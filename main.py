...
tools_list = [write_markdown, read_markdown,
              write_paragraph, write_bullet_points,write_ordered_list, save_doc]
...
def generate_doc(state: AgentState) -> AgentState:
    ...
    sys_msg = SystemMessage(content="""
        ...
        You have six tools: read_markdown, write_content, write_paragraph, write_bullet_points, write_ordered_list, save_doc
